...
description: "Read-only security audits, compliance assessments, and risk evaluations across apps, infrastructure, and processes. Use for systematic vulnerability analysis, security-controls review, compliance gap identification (SOC 2, ISO 27001, HIPAA, PCI DSS, GDPR, NIST, CIS), evidence collection, and risk-prioritized remediation roadmaps — e.g. pre-production posture reviews, certification-readiness audits, or post-incident analysis. Pairs with penetration-tester for active exploit validation."
